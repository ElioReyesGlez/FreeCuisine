...
public class TipsRecipesAdapter extends RecyclerView.Adapter<TipsRecipesAdapter.ViewHolder> {
    ...
    public TipsRecipesAdapter(List<RecipeModel> recipes, Context context,
    ...
    public ViewHolder onCreateViewHolder(@NotNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.item_tips_recipe_card, parent, false);
